...
//applywriter.php
$jieqiLang['article']['has_been_writer']='您已经拥有发表文章的权利，系统将自动跳转到作家专区。<br /><br /><a href="myarticle.php">点击这里直接进入作家专区</a><script language="javascript">setTimeout(function(){document.location="myarticle.php";}, 2000);</script>';
...
$jieqiLang['article']['apply_confirm_text']='您的申请作者请求已经通过，现在起可以使用本站作者功能，感谢您的支持！';
