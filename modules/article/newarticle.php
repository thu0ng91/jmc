 ...
 * @author     $Author: juny $
 * @version    $Id: newarticle.php 339 2009-06-23 03:03:24Z juny $
 */
	...
	case 'newarticle':
		...
		if(empty($errtext)) {
			...
			if(jieqi_checkpower($jieqiPower['article']['transarticle'], $jieqiUsersStatus, $jieqiUsersGroup, true)){
				...
				$newArticle->setVar('permission', intval($jieqiOption['article']['permission']['items'][$jieqiOption['article']['permission']['default']]));
			}
