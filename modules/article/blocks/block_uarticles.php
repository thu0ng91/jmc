 ...
 * @author     $Author: juny $
 * @version    $Id: block_uarticles.php 339 2009-06-23 03:03:24Z juny $
 */
...
class BlockArticleUarticles extends JieqiBlock
{
	...
	//uid: 'self' = 自己, 'uid' = $_REQUEST['uid'], '$uid' = {?$uid?}, 0 = 所有人, >0 = 某个人
	...
	function getCacheid(){
		...
		if(strval($this->exevars['uid']) != '0'){
			...
			elseif(substr($this->exevars['uid'],0,1) == '$') $this->blockvars['cacheid']=intval($jieqiTpl->get_assign(substr($this->exevars['uid'],1)));
