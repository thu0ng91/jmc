...
$jieqiCollect['author']['left'] = '<address>作者：<a target="_blank" href="/main/author.do!>';
$jieqiCollect['author']['right'] = '</a>';
$jieqiCollect['author']['middle'] = '!!!!';
$jieqiCollect['sort']['left'] = '<a href="/">首页</a>!&raquo;!<a href="~" target="_blank">';
$jieqiCollect['sort']['right'] = '</a>!&raquo;';
$jieqiCollect['sort']['middle'] = '!!!!';
$jieqiCollect['keyword']['left'] = '<b>标签:</b>';
...
$jieqiCollect['sortid']['都市娱乐'] = '3';
$jieqiCollect['sortid']['历史军事'] = '4';
$jieqiCollect['sortid']['女性时尚'] = '10';
$jieqiCollect['sortid']['游戏竞技'] = '6';
$jieqiCollect['sortid']['恐怖灵异'] = '8';
$jieqiCollect['sortid']['文化社科'] = '10';
$jieqiCollect['sortid']['经管励志'] = '10';
$jieqiCollect['sortid']['畅销经典'] = '10';
...
$jieqiCollect['volume']['right'] = '</b><cite><a href="javascript:readvolume($);">【分卷阅读】</a></cite></div>';
$jieqiCollect['volume']['middle'] = '!!!!';
$jieqiCollect['chapter']['left'] = '<li><a title=\'字数：$,更新日期：~\' href="/html/books/~" target="_blank">';
$jieqiCollect['chapter']['right'] = '</a></li>';
$jieqiCollect['chapter']['middle'] = '!!!!';
$jieqiCollect['chapterid']['left'] = '<li><a title=\'字数：$,更新日期：~\' href="/html/books/';
