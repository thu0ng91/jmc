...
echo '
<li><div>验证码：<input type="text" class="text" size="4" maxlength="8" name="checkcode"><img src="'.$this->_tpl_vars['url_checkcode'].'" style="cursor:pointer;vertical-align:middle;*margin-bottom:7px;" onclick="this.src=\''.$this->_tpl_vars['url_checkcode'].'\';"></div></li>
';
}
echo '
...
echo '
  ...
  <li style="width:49%;float:left;"><a href="'.$this->_tpl_vars['jieqi_user_url'].'/logout.php" class="logout">退出登录2</a></li>
</ul>
<div class="cb"></div>
