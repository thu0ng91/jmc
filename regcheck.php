...
switch($_GET['item']){
	case 'u': 
		...
		}elseif(preg_match('/^\s*$|^c:\\con\\con$|[@%,;:\.\|\*\"\'\\\\\/\s\t\<\>\&]|　/is', $_GET['username'])){//是否安全字符
		...
		}elseif($users_handler->getByname($_GET['username'], 3) != false){//是否已注册
