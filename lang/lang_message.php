...
$jieqiLang['system']['message_send_seccess']='恭喜您，消息已经成功发送给对方！';
...
$jieqiLang['system']['message_need_score']='<span class="hottext">您已经超出每天发送 %s 条消息的限制，如要继续发送，将消耗您的积分 %s 点</span>';
