 ...
 * @author     $Author: juny $
 * @version    $Id: block_userlist.php 344 2009-06-23 03:06:07Z juny $
 */
	...
	function BlockSystemUserlist(&$vars){
		...
		if(!empty($this->blockvars['vars'])){
			...
			if($arynum>0){
				...
				if(in_array($varary[0], array('score', 'monthscore', 'weekscore', 'dayscore', 'experience', 'regdate', 'lastlogin', 'credit'))) $this->exevars['field']=$varary[0];
			}
